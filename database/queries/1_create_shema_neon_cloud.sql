-- =====================================================
-- DATA INDUSTRY INSIGHTS – POSTGRESQL SCHEMA
-- =====================================================
...
CREATE TABLE job_postings (
    ...
    education_level VARCHAR(50)
        CHECK (education_level IN ('High School', 'Bachelor', 'Master', 'PhD')),
    employment_type VARCHAR(20)
        CHECK (employment_type IN ('Full-time', 'Part-time', 'Internship', 'Temporary')),
    job_description TEXT,
    remote_option VARCHAR(20)
        CHECK (remote_option IN ('Onsite', 'Hybrid', 'Remote'))
);
...
CREATE TABLE job_levels (
    ...
    job_level VARCHAR(20)
        CHECK (job_level IN ('Intern', 'Junior', 'Mid', 'Senior', 'Lead')),
