...
EXTRACTED_DIR = ROOT / "data" / "data_processing" / "s2.0_data_extracted"
...
if mapped_count < extracted_count:
    ...
    print(
        f"❌ STEP 2.1 FAILED – {missing} extracted file(s) have NOT been mapped"
    )
    sys.exit(1)
else:
    print("✅ STEP 2.1 PASSED – All extracted files have been mapped")
    sys.exit(0)