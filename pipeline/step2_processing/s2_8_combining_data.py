# -*- coding: utf-8 -*-
"""
STEP 2.8 – COMBINE STANDARDIZED DATA FILES

Purpose:
- Merge all standardized CSV files from STEP 2.7
...
Output:
- data/data_processing/s2.8_data_combined/combined_all_sources.csv
"""
...
OUTPUT_DIR = BASE_DIR / "data" / "data_processing" / "s2.8_data_combined"
