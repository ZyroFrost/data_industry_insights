# -*- coding: utf-8 -*-
"""
STEP 2.5 – ENRICHING SKILL LEVEL

This step enriches `skill_level_required` using predefined keyword mappings.
It infers skill level based on role name and job description signals only.

IMPORTANT PRINCIPLES:
1. Only enrich when `skill_name != "__NA__"`
2. Priority: role_name → job_description
3. NO guessing, NO ML, NO external NLP
4. Skill level ENUM is fixed and validated
5. Unmatched or ambiguous cases are explicitly tracked
"""
...
def enrich_file(file_path: Path):
    ...
    print(
        ...
        f"    - Skill empty (__NA__)      : {skill_empty}\n"
